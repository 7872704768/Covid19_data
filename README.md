# This Python script retrieves the latest COVID-19 data for Indian states from the [COVID-19 India API](https://data.covid19india.org/v4/min/timeseries.min.json).
